...
#clear
#sl
#echo -e "                  ${BG_RED}LTT CROWN V8.4${NC}"
#sleep 2
clear
echo -e "${GREEN}
...
${GREEN}┃             ${GREEN}${BOLD}TOOLS BY LEONORE TECH TEAM${GREEN}            ┃
┃              ${RED}___________${YELLOW}___________${GREEN}            ┃
┃                                                ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
${RED}┃          ${YELLOW}YT${RED}: ${GREEN}LttCrownBot ${YELLOW}TT${RED}: ${GREEN}LeonoreTechTeam${RED}             ┃
${RED}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
echo -e "    ${BG_RED}${YELLOW}WELCOME TO REGISTRASI & LOGIN LTT CROWN${NC}"
...
main_menu() {
    while true; do
        ...
        echo -e "${GREEN}┃${BG_RED}${YELLOW}MENU LOGIN LTT CROWN V1.0${NC}${GREEN}┃${NC}    ${GREEN}┃   ${BG_RED}${YELLOW}INFORMASI TOOLS${NC}${GREEN}   ┃${NC}"
        echo -e "${GREEN}┏━━━━━━━━━━━━━━━━━━━━━┓${NC}    ${GREEN}┏━━━━━━━━━━━━━━━━━━━━━┓${NC}"
